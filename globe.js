    ...
    (() => {
        ...
        h.VantaBase = class {
            constructor(t = {}) {
                ...
                if (
                    ((this.options = Object.assign({ mouseControls: !1, touchControls: !1, gyroControls: !1, minHeight: 600, minWidth: 600, scale: 1, scaleMobile: 1 }, e)),
                ...
                try {
                    ...
                    return (
                        ...
                        void (
                            ...
                            (console.log("[VANTA] Falling back to backgroundColor"), (this.el.style.background = ((i = this.options.backgroundColor), "number" == typeof i ? "#" + ("00000" + i.toString(16)).slice(-6) : i)))
                        )
                    );
                }
            ...
            initThree() {
                r.WebGLRenderer
                    ? ((this.renderer = new r.WebGLRenderer({ alpha: !0, antialias: !0 })),
        ...
        class d extends l {
            static initClass() {
                this.prototype.defaultOptions = { color: 16727937, color2: 16777215, size: 1, backgroundColor: 2299196, points: 0, maxDistance: 0, spacing: 0, showDots: !1 };
            }
            constructor(t) {
                (p = t.THREE || p), super(t);
            }
            ...
            onInit() {
                ...
                h.setAttribute("position", new p.BufferAttribute(this.linePositions, 3).setUsage(p.DynamicDrawUsage)),
                    ...
                    h.setDrawRange(0, 0);
                const a = new p.LineBasicMaterial({ vertexColors: p.VertexColors, blending: "additive" === this.blending ? p.AdditiveBlending : null, transparent: !0 });
                ...
                this.scene.add(l),
                    (this.spot = new p.SpotLight(16777215, 0)),
                ...
                (this.linesMesh2 = new p.LineSegments(u, c)), this.linesMesh2.position.set(100, 100, 100), this.cont2.add(this.linesMesh2);
                // lines around the globe
                const m = new p.LineBasicMaterial({ color: this.options.color2, linewidth: 2 }),
                    w = [];
                w.push(new p.Vector3(0, 0, 0)), w.push(new p.Vector3(0, 0, 0));
                for (let t = 0; t < 4; t++) {
                    let e = 0.15 * Math.sin((t / 4) * Math.PI * 2),
                    //x inside the globe
            ...
            onUpdate() {
                ...
                Math.abs(e.tx - e.position.x) > 0.01 && ((t = e.tx - e.position.x), (e.position.x += 0.02 * t)),
                    ...
                    c && window.innerWidth < 480 ? e.lookAt(new p.Vector3(-10, 0, 0)) : c && window.innerWidth < 720 ? e.lookAt(new p.Vector3(-20, 0, 0)) : e.lookAt(new p.Vector3(-40, 0, 0));
                let s = 0,
                    i = 0,
                    o = 0;
                ...
                for (let t = 0; t < this.points.length; t++) {
                    ...
                    (l.scale.z = (0.25 * (15 - c)).clamp(1, 100)), (l.scale.x = l.scale.y = l.scale.z), (l.position.y = 2 * Math.sin(l.position.x / 10 + 0.01 * this.t + (l.position.z / 10) * 0.5));
                    for (let h = t; h < this.points.length; h++) {
                        ...
                        if (((e = Math.sqrt(c * c + d * d + u * u)), e < this.options.maxDistance)) {
                            ...
                            (c = c.clamp(0, 1)),
                                (h = "additive" === this.blending ? new p.Color(0).lerp(a, c) : n.clone().lerp(r, c)),
            ...
            onMouseMove(t, e) {
                ...
                (s.tz = o * Math.sin(n)), (s.tx = o * Math.cos(n)), (s.ty = s.oy + 80 * (e - 0.5) * (this.options.mouseCoeffY || 1)), this.rayCaster, (this.rcMouseX = 2 * t - 1), (this.rcMouseY = 2 * -t + 1);
            }
            onRestart() {
